...
public class UIManager: Singleton<UIManager>
{
    ...
    private GameObject _uiRootGameObject;       // UI_CanvasObject
    ...
    private string _uiRootPath = "Prefabs/UI/";      // UI预制件的路径
    ...
    public void Init()
    {
        _uiRootGameObject = GameObject.Find("UIRoot");
        Object.DontDestroyOnLoad(_uiRootGameObject);

        _uiCamera = GameObject.Find("UIRoot/UICamera");
        _uiContainerGameObject = GameObject.Find("UIRoot/Container");
        _eventSystemGameObject = GameObject.Find("UIRoot/EventSystem");
    }
